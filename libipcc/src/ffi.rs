...
extern "C" {
    ...
    pub fn libipcc_fini(lih: *mut libipcc_handle_t);
    pub fn libipcc_err(lih: *mut libipcc_handle_t) -> libipcc_err_t;
    pub fn libipcc_syserr(lih: *mut libipcc_handle_t) -> c_int;
    pub fn libipcc_errmsg(lih: *mut libipcc_handle_t) -> *const c_char;
    pub fn libipcc_keylookup(
    ...
    pub fn libipcc_rot_send(
        lih: *mut libipcc_handle_t,
        request: *const u8,
        len: usize,
        rotrp: *mut *mut libipcc_rot_resp_t,
    ) -> bool;
    pub fn libipcc_rot_resp_get(
        rotrp: *mut libipcc_rot_resp_t,
        lenp: *mut usize,
    ) -> *const u8;
    pub fn libipcc_rot_resp_free(rotrp: *mut libipcc_rot_resp_t);
}
